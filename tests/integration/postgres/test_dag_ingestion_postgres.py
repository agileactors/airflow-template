...
def test_ingestion_happens_successfully_pg_server(setup_and_teardown_fixture, airflow_api_utils_fixture):
    ...
    logs = airflow_api_utils_fixture.get_dag_run_logs(dag_id=dag_under_test_id,
...
def test_ingestion_happens_successfully_pg_server_with_chunk_2(setup_and_teardown_fixture,
                                                               airflow_api_utils_fixture):
